...
export const CONSTELLATION_SLIDES: ConstellationSlide[] = [
  {
    ...
    imageSrc: publicAsset('/constellations/orion.png'),
  ...
  },
  {
    ...
    imageSrc: publicAsset('/constellations/cygnus.png'),
  ...
  },
  {
    ...
    imageSrc: publicAsset('/constellations/cassiopeia.png'),
  ...
  },
  {
    ...
    imageSrc: publicAsset('/constellations/big-dipper.png'),
